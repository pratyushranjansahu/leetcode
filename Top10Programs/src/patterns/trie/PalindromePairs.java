 ...
 * https://www.youtube.com/watch?v=iqM6xYQcsx0
 */
public class PalindromePairs {

    public static void main(String[] args) {
        String[] words = {"abcd","dcba","lls","s","sssll"};
        System.out.println(palindromePairs(words));//[[0, 1], [1, 0], [2, 4], [3, 2]]
    }
    ...
    private static void search(String[] words, int i, TrieNode root,
